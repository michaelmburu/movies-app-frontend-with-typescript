    ...
    <>
      {movie ? (
        <div>
          ...
          <Ratings maximumValue={5} selectedValue={movie.userRating} onChange={handleRate} /> | Average Rating: {movie.averageRating}
            ...
            {movie.trailer ? (
              <div>
                <iframe
                  ...
                  allow='accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picure'
                  allowFullScreen
                ></iframe>
              </div>
            ) : null}
